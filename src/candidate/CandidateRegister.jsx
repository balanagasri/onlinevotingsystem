...
export default function AddCandidate() {
  ...
  return (
    <div>
      <h3 style={{ textAlign: "center", textDecoration: "underline" }}>Add Candidate</h3>
      {message ? 
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label>Party</label>
          <input type="text" id="party" value={formData.party} onChange={handleChange} required />
        </div>
        <div>
          <label>Area</label>
          <input type="text" id="area" value={formData.area} onChange={handleChange} required />
        </div>
